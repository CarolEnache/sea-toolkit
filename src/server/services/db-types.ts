...
export type SqlFiles = 'footprint.add_analyst-industries' | 'footprint.del_analyst-industries' | 'footprint.get_analyst-industries' | 'generic.del' | 'generic.get' | 'generic_mod' | 'msr.get_products' | 'nace.get_nace-codes' | 'oecd.get_oecd-codes' | 'oecd.get_regions' | 'report.add_request' | 'report.get_request' | 'report_add_result' | 'unido.get_isic-codes' | 'unido.pivot_region-year-isic';
