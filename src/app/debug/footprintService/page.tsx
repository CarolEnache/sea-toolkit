  ...
  return (
    <div>
      ...
      <form action={setAnalystIndustries}>
        <label>NACE code: <input type="text" name="NACE" defaultValue="C2120" /></label>
        <label>ISIC code: <input type="text" name="ISIC" defaultValue="2100" /></label>
        <label>OECD code: <input type="text" name="OECD" defaultValue="D20T21" /></label>
