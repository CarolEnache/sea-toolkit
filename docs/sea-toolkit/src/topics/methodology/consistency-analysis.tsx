  ...
  return (
    <>
      ...
      <Text>
        A
        {' '}
        <Link href="https://en.wikipedia.org/wiki/Input%E2%80%93output_model">Leontief input-output model</Link>
        {' '}
        depicts and analyzes the dependencies between
      ...
      <Text>
        ...
        {' '}
        <Link href="https://en.wikipedia.org/wiki/Economic_base_analysis">location quotients</Link>
        {' '}
        follows a hybrid approach, where different data sources
